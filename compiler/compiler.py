...
def _resolve_load_dotenv():  # pragma: no cover - optional dependency
...
ENV_CANDIDATES = [
    PROJECT_ROOT / ".env",
    PROJECT_ROOT / "agent_specification_language/.env",
...
DEFAULT_LLM_PROFILES: Dict[str, Dict[str, Any]] = {
    "rapid_reasoner": {"model": "gpt-4o-mini", "temperature": 0.0, "max_tokens": 600},
    "balanced_agent": {"model": "gpt-4o", "temperature": 0.35, "max_tokens": 900},
    "creative_planner": {"model": "gpt-4o", "temperature": 0.55, "max_tokens": 1200},
}
...
import os
import uuid
from typing import Any, Dict, List, Tuple, TypedDict, Optional, Annotated
import requests
import yaml
